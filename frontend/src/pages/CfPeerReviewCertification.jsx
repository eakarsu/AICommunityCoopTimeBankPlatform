...
/**
 * Gap/CFS Feature Page: Peer review & certification
 * Slug: peer-review-certification
 * Backend: /api/cf-peer-review-certification
 */
export default function PeerReviewCertificationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-peer-review-certification', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Peer review & certification</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Crowdsourced skill verification with weighted credibility.</p>
