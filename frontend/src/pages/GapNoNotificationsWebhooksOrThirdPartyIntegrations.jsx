...
/**
 * Gap/CFS Feature Page: No notifications, webhooks, or third-party integrations.
 * Slug: no-notifications-webhooks-or-third-party-integrations
 * Backend: /api/gap-no-notifications-webhooks-or-third-party-integrations
 */
export default function NoNotificationsWebhooksOrThirdPartyIntegrationsPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-notifications-webhooks-or-third-party-integrations', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No notifications, webhooks, or third-party integrations.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No notifications, webhooks, or third-party integrations.</p>
