...
/**
 * Gap/CFS Feature Page: No governance/voting module.
 * Slug: no-governance-voting-module
 * Backend: /api/gap-no-governance-voting-module
 */
export default function NoGovernanceVotingModulePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-governance-voting-module', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No governance/voting module.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No governance/voting module.</p>
