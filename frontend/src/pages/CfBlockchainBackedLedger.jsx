...
/**
 * Gap/CFS Feature Page: Blockchain-backed ledger
 * Slug: blockchain-backed-ledger
 * Backend: /api/cf-blockchain-backed-ledger
 */
export default function BlockchainBackedLedgerPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-blockchain-backed-ledger', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Blockchain-backed ledger</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Immutable transaction record for transparency.</p>
