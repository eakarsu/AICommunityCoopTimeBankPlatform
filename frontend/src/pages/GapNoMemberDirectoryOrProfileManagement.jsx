...
/**
 * Gap/CFS Feature Page: No member directory or profile management.
 * Slug: no-member-directory-or-profile-management
 * Backend: /api/gap-no-member-directory-or-profile-management
 */
export default function NoMemberDirectoryOrProfileManagementPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-member-directory-or-profile-management', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No member directory or profile management.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No member directory or profile management.</p>
