...
/**
 * Gap/CFS Feature Page: No time-credit ledger or transaction history.
 * Slug: no-time-credit-ledger-or-transaction-history
 * Backend: /api/gap-no-time-credit-ledger-or-transaction-history
 */
export default function NoTimeCreditLedgerOrTransactionHistoryPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-time-credit-ledger-or-transaction-history', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No time-credit ledger or transaction history.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No time-credit ledger or transaction history.</p>
