...
/**
 * Gap/CFS Feature Page: Multi-modal intake (voice/photo)
 * Slug: multi-modal-intake-voice-photo
 * Backend: /api/cf-multi-modal-intake-voice-photo
 */
export default function MultiModalIntakeVoicePhotoPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-multi-modal-intake-voice-photo', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Multi-modal intake (voice/photo)</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Allow members to describe skills via voice notes or photo evidence.</p>
